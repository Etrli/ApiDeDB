//Esta es nuestra "Base de Datos" en la que guardamos nuestra data como objeto(data),
//  y dentro tiene otro objeto(items) con atributos(id,name,ki,etc)
const data = {
	items: [
		{
			id: 1,
...
//esto lo exporta por defecto toda la data
export default data;